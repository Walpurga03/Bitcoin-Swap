    ...
    <div class="modal-content" on:click|stopPropagation>
      ...
      <div class="modal-body">
        ...
        <div class="info-box">
          ...
          <ul>
            ...
            <li>Deine Identität bleibt anonym bis zur Auswahl</li>
          </ul>
        </div>
        
        <div class="info-text">
          <p>🔒 Dein Interesse wird verschlüsselt gespeichert</p>
          <p>👤 Nur der Angebotsgeber kann es sehen</p>
        </div>
      </div>
      ...
      <div class="modal-footer">
        ...
        <button 
          ...
          disabled={sending}
        >
          {sending ? '⏳ Sende...' : '✋ Interesse zeigen'}
        </button>
      </div>
    </div>
  </div>
